...
public class ModPerson extends JFrame implements Screen{
	 ...
	 */
	private static ModPerson instance;
	/**
	 * Launch the application.
	 */

	public static ModPerson getInstance(){
		if(instance == null){
			instance = new ModPerson();
		}
		return instance;
	}
	@Override
	...
	private ModPerson() {
		...
		JLabel lblNewLabel = new JLabel("S\u1EEDa d\u00E2n c\u01B0");
		...
		JButton btnMod = new JButton("S\u1EEDa");
